...
function initShaderLines(host: HTMLDivElement, canvas: HTMLCanvasElement): void {
  ...
  function link(vertSrc: string, fragSrc: string): Prog | null {
...
document.addEventListener("DOMContentLoaded", () => {
  const host = document.getElementById("shader-host") as HTMLDivElement | null;
  const canvas = document.getElementById("shader-canvas") as HTMLCanvasElement | null;
  if (host && canvas) initShaderLines(host, canvas);
});
