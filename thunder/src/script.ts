interface LightningConfig {
  ...
  size: number;       // zoom level of the noise
}

(function (): void {
  const canvas = document.getElementById('lightningCanvas') as HTMLCanvasElement | null;

  if (!canvas) {
    console.error('Canvas element with id "lightningCanvas" not found');
    return;
  }
