...
function initShaderProgram(glCtx, vsSrc, fsSrc) {
    const vertexShader = loadShader(glCtx, glCtx.VERTEX_SHADER, vsSrc);
    const fragmentShader = loadShader(glCtx, glCtx.FRAGMENT_SHADER, fsSrc);
