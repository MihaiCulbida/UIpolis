...
class VioletMesh {
    ...
    constructor(container, canvas, strandColor = "#a855f7") {
    ...
    displaced(point, withCursorForce = true) {
        const coords = {
    ...
    movePoints(time) {
        const { WAVE_TIME_X_FACTOR, WAVE_NOISE_X_FACTOR, WAVE_TIME_Y_FACTOR, WAVE_NOISE_Y_FACTOR, WAVE_NOISE_MAGNITUDE, WAVE_AMPLITUDE_X, WAVE_AMPLITUDE_Y, POINTER_INFLUENCE_RADIUS, POINTER_FALLOFF_FACTOR, POINTER_FORCE_FACTOR, TENSION_STRENGTH, FRICTION, DISPLACEMENT_STRENGTH, MAX_DISPLACEMENT, } = meshConfig;
